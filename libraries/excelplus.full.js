...
ExcelPlus.prototype = {
    ...
    */
     ...
     *
     * @param {String|Number} sheet If it's a number (starting from) that reprents the sheet position in the Excel file, otherwise it must be the name of the sheet (case sensitive)
     */
