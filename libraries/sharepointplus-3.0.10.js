...
(function(window) {
  ...
  SharepointPlus.prototype = {
    ...
    */
   getVersion:function() { return "3.0.10" },
    /**
      @name $SP().list
      @namespace
    ...
    */
    ...
    /**
      ...
      @param {Object} [setup] Options (see below)
        ...
        @parma {Boolean} [setup.useIndexForOrderBy=false] Based on https://spservices.codeplex.com/discussions/280642#post1323410 it permits to override the 5,000 items  limit in an unique call -- see the example below to know how to use it
                  ...
                  case "text":
                    ...
                    if (input[inp].className.indexOf("ms-input") > -1 || input[inp].className.indexOf("ms-long") > -1) {
                      ...
                      if (input[inp].id.search(/DateTimeFieldDate$/) > -1) {
                        ...
                        elem.pop();
                        elem.push(input[inp].previousElementSibling || input[inp].previousSibling);
                        elem.push(input[inp])
